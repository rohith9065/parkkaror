-- Run this to update your database schema for complete rental space support
...
-- 2. Parking Spaces Table (Updated with more fields)
...
-- Insert default amenities and features
